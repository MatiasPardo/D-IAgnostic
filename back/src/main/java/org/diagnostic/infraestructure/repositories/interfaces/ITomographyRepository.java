...
public interface ITomographyRepository {
    ...
    List<Tomography> findByUserId(String codeReport, String dni, String hc, String title);
    Page<Tomography> findByUserId(String codeReport, String dni, String hc, String title, Pageable pageable);
